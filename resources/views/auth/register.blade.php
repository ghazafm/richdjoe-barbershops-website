        ...
        .input-text-color {
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="flex items-center justify-end mt-4 dark-text">
                    <a class="underline text-sm text-gray-600 hover:text-white-900 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark-text" href="{{ route('login') }}">
