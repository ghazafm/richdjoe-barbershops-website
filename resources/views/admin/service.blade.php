...
<head>
    ...
    <style>
        ...
        /* Custom CSS to display Edit and Delete buttons in one line */
        .btn-group {
            display: flex;
        ...
        <div class="page-header">
            <div class="container-fluid">
                ...
                <form action="/admin/service/search" method="GET" class="form-inline mb-3">
                    <input type="text" name="search" class="form-control mr-2" placeholder="Search Service"
                        value="{{ old('search') }}">
                                ...
                                <td class="text-center">
                                    <div class="btn-group">
                                        <a class="btn btn-warning btn-sm"
                                            href="/admin/service/edit/{{ $svc->id }}">Edit</a>
                                        <a class="btn btn-danger btn-sm"
                                            href="/admin/service/delete/{{ $svc->id }}">Delete</a>
                                    </div>
                                </td>
                            </tr>
                        @endforeach
