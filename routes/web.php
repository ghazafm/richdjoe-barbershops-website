...
Route::get('/book/service/haircut/kapster/schedule/confirmation/{place}/{service}/{kapster}/transaction', [UserBookController::class, 'detail'])->middleware('auth', 'verified');
