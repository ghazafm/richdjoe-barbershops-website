...
Route::get('/admin/dashboard', [AdminUserController::class, 'dashboard'])->middleware(['auth', 'admin']);
...
Route::get('/admin/book/history', [AdminBookController::class, 'add'])->middleware(['auth', 'admin']);
